...
public  class Rtsp {
    ...
    String getDescribe(VideoMetadata meta, int RTP_dest_port) {
        ...
        // SDP-Beschreibung (Body)
        rtspBody.write("v=0" + CRLF); // Protokollversion
        rtspBody.write("o=- 0 0 IN IP4 127.0.0.1" + CRLF); // Sitzungsersteller
        rtspBody.write("s=RTSP-Streaming" + CRLF); // Sitzungsname
        rtspBody.write("i=Streaming Example" + CRLF); // Info
        rtspBody.write("t=0 0" + CRLF); // Zeitbeschreibung (immer aktiv)
